...
<html>
	...
	<body>
		<a href="#edit-solicitudArchivoadjunto" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-solicitudArchivoadjunto" class="content scaffold-edit" role="main">
			...
			<g:form method="post"  enctype="multipart/form-data">
				...
				<g:hiddenField name="version" value="${solicitudArchivoadjuntoInstance?.version}" />
				<fieldset class="form">
