		...
		<div id="show-solicitudDetalle" class="content scaffold-show" role="main">
			...
			<ol class="property-list solicitudDetalle">
				...
				<li class="fieldcontain">
					<span id="idSolicitud-label" class="property-label"><g:message code="solicitudDetalle.idSolicitud.label" default="Solicitud" /></span>
              ...
              ${solicitudDetalleInstance?.idSolicitud?.encodeAsHTML()}
				...
				<li class="fieldcontain">
					<span id="idServ-label" class="property-label"><g:message code="solicitudDetalle.idServ.label" default="Tercer nivel" /></span>
              ...
              ${solicitudDetalleInstance?.idPrograma?.encodeAsHTML()}
				...
				<li class="fieldcontain">
					<span id="idServcat-label" class="property-label"><g:message code="solicitudDetalle.idServcat.label" default="Categoría" /></span>
						...
						<span class="property-value" aria-labelledby="idServcat-label">
              ${solicitudDetalleInstance?.idServcat?.encodeAsHTML()}
            </span>
