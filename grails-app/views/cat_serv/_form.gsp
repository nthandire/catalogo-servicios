...
<div class="fieldcontain ${hasErrors(bean: cat_servInstance, field: 'portal', 'error')} ">
	<label for="portal">
...
<div class="fieldcontain ${hasErrors(bean: cat_servInstance, field: 'authoriza', 'error')} ">
	...
	<g:textField name="authoriza" value="${cat_servInstance?.authoriza}"/>
</div>

<div class="fieldcontain ${hasErrors(bean: cat_servInstance, field: 'servResp', 'error')} required">
	<label for="servResp">
