...
<div class="fieldtablecontain ${hasErrors(bean: cat_servInstance, field: 'servResp1', 'error')} required">
	...
	<g:select id="servResp1" name="servResp1.id" from="${Cat_servResp.list()}" optionKey="id" required="" value="${cat_servInstance?.servResp1?.id}" class="many-to-one" disabled="true"/>
</div>
...
<div class="fieldtablecontain ${hasErrors(bean: cat_servInstance, field: 'unidades1', 'error')} required">
	...
	<g:select id="unidades1" name="unidades1.id" from="${Cat_tiempo.list()}" optionKey="id" required="" value="${cat_servInstance?.unidades1?.id}" class="many-to-one" disabled="true"/>
</div>
...
<div class="fieldtablecontain ${hasErrors(bean: cat_servInstance, field: 'servResp2', 'error')} ">
	...
	<g:select id="servResp2" name="servResp2.id" from="${Cat_servResp.list()}" optionKey="id" value="${cat_servInstance?.servResp2?.id}" class="many-to-one" noSelection="['null': '']" disabled="true"/>
</div>
...
<div class="fieldtablecontain ${hasErrors(bean: cat_servInstance, field: 'unidades2', 'error')} required">
	...
	<g:select id="unidades2" name="unidades2.id" from="${Cat_tiempo.list()}" optionKey="id" required="" value="${cat_servInstance?.unidades2?.id}" class="many-to-one" disabled="true"/>
</div>
...
<div class="fieldtablecontain ${hasErrors(bean: cat_servInstance, field: 'servResp3', 'error')} ">
	...
	<g:select id="servResp3" name="servResp3.id" from="${Cat_servResp.list()}" optionKey="id" value="${cat_servInstance?.servResp3?.id}" class="many-to-one" noSelection="['null': '']" disabled="true"/>
</div>
...
<div class="fieldtablecontain ${hasErrors(bean: cat_servInstance, field: 'unidades3', 'error')} required">
	...
	<g:select id="unidades3" name="unidades3.id" from="${Cat_tiempo.list()}" optionKey="id" required="" value="${cat_servInstance?.unidades3?.id}" class="many-to-one" disabled="true"/>
</div>
...
<div class="fieldcontain ${hasErrors(bean: cat_servInstance, field: 'autoriza', 'error')} ">
	<label for="autoriza">
		<g:message code="cat_serv.autoriza.label" default="Autoriza" />

	</label>
	<g:select id="autoriza" name="autoriza.id" from="${Cat_servResp.list()}" optionKey="id" value="${cat_servInstance?.autoriza?.id}" class="many-to-one" noSelection="${['null':'N/A']}" disabled="true"/>
</div>
...
<div class="fieldtablecontain ${hasErrors(bean: cat_servInstance, field: 'servResp', 'error')} required">
	...
	<g:select id="servResp" name="servResp.id" from="${Cat_servResp.list()}" optionKey="id" value="${cat_servInstance?.servResp?.id}" class="many-to-one" noSelection="${['null':'N/A']}" disabled="true"/>
</div>
