...
<html>
	...
	<body>
		<a href="#edit-incidenteArchivoadjunto" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-incidenteArchivoadjunto" class="content scaffold-edit" role="main">
			...
			<g:form method="post"  enctype="multipart/form-data">
				...
				<g:hiddenField name="version" value="${incidenteArchivoadjuntoInstance?.version}" />
				<fieldset class="form">
