	...
	<body>
		...
		<div class="nav" role="navigation">
			<ul>
				...
				<li><g:link class="back" action="edit" id="${solicitudArchivoadjuntoInstance?.idSolicitud?.id}">Regresar a la solicitud</g:link></li>
			</ul>
		</div>
		<div id="show-solicitudArchivoadjunto" class="content scaffold-show" role="main">
			...
			<ol class="property-list solicitudArchivoadjunto">
				...
				<li class="fieldcontain">
					<span id="idSolicitud-label" class="property-label"><g:message code="solicitudArchivoadjunto.idSolicitud.label" default="Folio de la Solicitud" /></span>
