			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="idProblema" title="${message(code: 'problema.idProblema.label', default: 'Id Problema')}" />
				...
				<g:each in="${problemaInstanceList}" status="i" var="problemaInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${problemaInstance.id}">${fieldValue(bean: problemaInstance, field: "idProblema")}</g:link></td>
					
						<td>${fieldValue(bean: problemaInstance, field: "fuente")}</td>
