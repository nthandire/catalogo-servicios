...
<html>
	<head>
		...
		<g:set var="entityName" value="${message(code: 'bitacora.label', default: 'Sistema')}" />
		<title><g:message code="default.edit.label" args="[entityName]" /></title>
	</head>
	<body>
		<a href="#edit-bitacora" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="edit-bitacora" class="content scaffold-edit" role="main">
