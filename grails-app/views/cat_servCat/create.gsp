...
<html>
	...
	<body>
		<a href="#create-cat_servCat" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
		...
		<div id="create-cat_servCat" class="content scaffold-create" role="main">
