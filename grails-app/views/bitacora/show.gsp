	...
	<body>
		...
		<div id="show-bitacora" class="content scaffold-show" role="main">
			...
			<ol class="property-list bitacora">
				...
				<g:if test="${bitacoraInstance?.desBitacora}">
				<li class="fieldcontain">
					<span id="desBitacora-label" class="property-label"><g:message code="bitacora.desBitacora.label" default="Des Bitacora" /></span>
					
						<span class="property-value" aria-labelledby="desBitacora-label"><g:fieldValue bean="${bitacoraInstance}" field="desBitacora"/></span>
